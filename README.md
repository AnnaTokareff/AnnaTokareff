<h1 align="center">Hi there! 👋 I'm Anna Tokareva</h1>
...
|---------|------------|-------------|
| **RAG PDF Pipeline** | Built a full Retrieval-Augmented Generation system for complex PDF documents using LlamaIndex, hybrid retrieval (BM25 + vector search), reranking, OCR fallback, and a Streamlit interface. | 🔗 [GitHub](https://github.com/AnnaTokareff/RAG_pdf_pipeline.git) |
